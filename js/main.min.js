!(function (e, t) {
          ...
          if (null != (e = arguments[r]))
            for (t in e)
              (n = e[t]),
                "__proto__" !== t &&
                  s !== n &&
                  (l && n && (S.isPlainObject(n) || (o = Array.isArray(n)))
                    ? ((i = s[t]),
                      (i =
                        o && !Array.isArray(i)
                          ? []
  ...
  var e = (function (I) {
      ...
      try {
        P.apply((t = Z.call(d.childNodes)), d.childNodes),
      ...
      function L(t, e, n, o) {
        ...
        if (!o && (T(e), (e = e || S), C)) {
          ...
          if (
            ...
            if (((c = t), (d = e), 1 === u && (oe.test(t) || ne.test(t)))) {
              for (
                ((d = (de.test(t) && me(e.parentNode)) || e) === e &&
                  p.scope) ||
                  ((r = e.getAttribute("id"))
                    ? (r = r.replace(ue, q))
          ...
          return (
            e != S &&
              ...
              (p.scope = H(function (e) {
                return (
                  n.appendChild(e).appendChild(S.createElement("div")),
              ...
              (p.getElementsByClassName = A.test(S.getElementsByClassName)),
              ...
              (o = []),
              (h = []),
              (p.qsa = A.test(S.querySelectorAll)) &&
                (H(function (e) {
                  var t;
                ...
                ? function (e, t) {
                    ...
                    return (
                      ...
                      (!p.sortDetached && t.compareDocumentPosition(e) === n)
                        ? e == S || (e.ownerDocument == d && g(d, e))
                          ? -1
                          : t == S || (t.ownerDocument == d && g(d, t))
                          ? 1
                          : l
                          ? y(l, e) - y(l, t)
                          : 0
      ...
      ((x = L.selectors =
        {
          ...
          filter: {
            TAG: function (e) {
              var t = e.replace(E, u).toLowerCase();
              return "*" === e
                ? function () {
                    return !0;
                  }
        ...
        return (
          ...
          j(function (e, t, n, o) {
            var i,
              ...
              u = !f || (!e && h) ? d : xe(d, a, f, n, o),
              p = g ? (v || (e ? f : c || m) ? [] : t) : u;
            if ((g && g(u, p, n, o), m))
              for (i = xe(p, l), m(i, [], n, o), s = i.length; s--; )
                (r = i[s]) && (p[l[s]] = !(u[l[s]] = r));
            if (e) {
              if (v || f) {
                if (v) {
            ...
            } else (p = xe(p === t ? p.splice(c, p.length) : p)), v ? v(null, t, p, o) : P.apply(t, p);
          })
        );
      }
      function Te(m, v) {
        function e(e, t, n, o, i) {
          ...
          if (((l += c), y && c !== l)) {
            ...
            P.apply(o, u),
              i && !e && 0 < u.length && 1 < l + v.length && L.uniqueSort(o);
          }
          return i && (($ = h), (w = p)), d;
        }
        var y = 0 < v.length,
        ...
        (f = L.tokenize =
          function (e, t) {
            ...
            for (r = e, a = [], l = x.preFilter; r; ) {
              for (s in ((n && !(o = te.exec(r))) ||
                (o && (r = r.slice(o[0].length) || r), a.push((i = []))),
              (n = !1),
              (o = ne.exec(r)) &&
                ((n = o.shift()),
                i.push({ value: n, type: o[0].replace(v, " ") }),
                (r = r.slice(n.length))),
              x.filter))
                !(o = b[s].exec(r)) ||
                  (l[s] && !(o = l[s](o))) ||
            ...
            return t ? r.length : r ? L.error(e) : _(e, a).slice(0);
          }),
        (F = L.compile =
          function (e, t) {
            var n,
          ...
          function (e, t, n, o) {
            ...
            if (((n = n || []), 1 === d.length)) {
              if (
                ...
                if (!(t = (x.find.ID(r.matches[0].replace(E, u), t) || [])[0]))
                  return n;
              ...
              for (
                ...
                if (
                  (l = x.find[a]) &&
                  (o = l(
                    r.matches[0].replace(E, u),
                    (de.test(s[0].type) && me(t.parentNode)) || t
                  ))
                ) {
                  if ((s.splice(i, 1), (e = o.length && O(s)))) break;
            ...
            return (
              (c || F(e, d))(
                ...
                !C,
                n,
                !t || (de.test(e) && me(t.parentNode)) || t
              ),
              n
            );
          }),
        (p.sortStable = k.split("").sort(Y).join("") === k),
  ...
  (S.filter = function (e, t, n) {
    ...
    S.fn.extend({
      ...
      is: function (e) {
        return !!K(this, "string" == typeof e && Z.test(e) ? S(e) : e || [], !1)
          .length;
      },
    });
  var J,
      ...
      (((S.fn.init = function (e, t, n) {
        ...
        if (o[1]) {
          if (
            ...
            S.merge(
              this,
              S.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : T, !0)
            ),
            G.test(o[1]) && S.isPlainObject(t))
          )
            for (var o in t) y(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
          return this;
        }
        return (
          (n = T.getElementById(o[2])) && ((this[0] = n), (this.length = 1)),
          this
        );
      }).prototype = S.fn),
      (J = S(T)),
        ...
        S.fn[o] = function (e, t) {
          ...
          return (
            (t = "Until" !== o.slice(-5) ? e : t) &&
              ...
              (n = S.filter(t, n)),
            1 < this.length &&
              (ne[o] || S.uniqueSort(n), te.test(o) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (S.Callbacks = function (o) {
    ...
    S.extend({
          ...
          r = {
            ...
            then: function (t, n, o) {
              ...
              return S.Deferred(function (e) {
                s[0][3].add(c(0, e, y(o) ? o : d, e.notifyWith)),
                  s[1][3].add(c(0, e, y(t) ? t : d)),
                  s[2][3].add(c(0, e, y(n) ? n : ie));
              }).promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          n <= 1 &&
          (se(e, r.done(t(o)).resolve, r.reject, !n),
          "pending" === r.state() || y(s[o] && s[o].then))
        )
          return r.then();
  ...
  function u(e, t, n, o, i, s, r) {
    var a = 0,
      l = e.length,
      c = null == n;
    if ("object" === h(n)) for (a in ((i = !0), n)) u(e, t, a, n[a], !0, s, r);
    else if (
      void 0 !== o &&
      ((i = !0),
      y(o) || (r = !0),
  ...
  S.extend({
    ...
    S.fn.extend({
      data: function (n, e) {
        ...
        if (
          this.length &&
          ((i = c.get(s)), 1 === s.nodeType && !x.get(s, "hasDataAttrs"))
        ) {
          for (t = r.length; t--; )
            r[t] &&
              0 === (o = r[t].name).indexOf("data-") &&
              ((o = b(o.slice(5))), ge(s, o, i[o]));
  ...
  function me(e, t) {
    return (
      ...
      ("" === e.style.display && $(e) && "none" === S.css(e, "display"))
    );
  }
  ...
  function $e(e, t, n, o, i) {
    for (
      ...
      if ((s = e[p]) || 0 === s)
        if ("object" === h(s)) S.merge(u, s.nodeType ? [s] : s);
        else if (ke.test(s)) {
          for (
    ...
    for (d.textContent = "", p = 0; (s = u[p++]); )
      if (o && -1 < S.inArray(s, o)) i && i.push(s);
      else if (((l = $(s)), (r = E(d.appendChild(s), "script")), l && Ce(r), n))
        for (c = 0; (s = r[c++]); ) Se.test(s.type || "") && n.push(s);
    return d;
  }
  var Pe = /^([^.]*)(?:\.(.+)|)/;
  function n() {
  ...
  function Le(e, i, s) {
    s
      ...
      : void 0 === x.get(e, i) && S.event.add(e, i, n);
  }
  (S.event = {
    global: {},
          ...
          (u = f = (p = Pe.exec(e[l]) || [])[1]),
            ...
            u &&
              ...
              (d = a[u]) ||
                ...
                (c.setup && !1 !== c.setup.call(t, o, p, r)) ||
        ...
        for (c = (t = (t || "").match(C) || [""]).length; c--; )
          if (
            ...
            r &&
              ...
              delete l[f]);
          } else for (f in l) S.event.remove(e, f + t[c], n, o, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = S.event.handlers.call(this, a, e), t = 0;
  ...
  function L(n, o, i, s) {
    ...
    var e,
      ...
      f = o[0],
      h = y(f);
    if (h || (1 < u && "string" == typeof f && !m.checkClone && je.test(f)))
    ...
    if (
      u &&
      ((t = (e = $e(o, n[0].ownerDocument, !1, n, s)).firstChild),
      1 === e.childNodes.length && (e = t),
      t || s)
    ) {
      for (a = (r = S.map(E(e, "script"), Oe)).length; d < u; d++)
        (l = e),
          d !== p &&
            ((l = S.clone(l, !0, !0)), a && S.merge(r, E(l, "script"))),
          i.call(n[d], l, d);
      if (a)
        for (c = r[r.length - 1].ownerDocument, S.map(r, Ie), d = 0; d < a; d++)
          (l = r[d]),
            Se.test(l.type || "") &&
              ...
              (l.src && "module" !== (l.type || "").toLowerCase()
                ...
                : U(l.textContent.replace(He, ""), l, c));
    }
    return n;
  }
  function Ne(e, t, n) {
    for (var o, i = t ? S.filter(t, e) : e, s = 0; null != (o = i[s]); s++)
      n || 1 !== o.nodeType || S.cleanData(E(o)),
        o.parentNode &&
          (n && $(o) && Ce(E(o, "script")), o.parentNode.removeChild(o));
    return e;
  }
  S.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (r = E(d), o = 0, i = (s = E(e)).length; o < i; o++)
          (a = s[o]),
            (l = r[o]),
            (c = void 0),
      ...
      if (t)
        if (n)
          for (s = s || E(e), r = r || E(d), o = 0, i = s.length; o < i; o++)
            qe(s[o], r[o]);
        else qe(e, d);
      return 0 < (r = E(d, "script")).length && Ce(r, !u && E(e, "script")), d;
    },
    ...
    S.fn.extend({
      ...
      empty: function () {
        for (var e, t = 0; null != (e = this[t]); t++)
          1 === e.nodeType && (S.cleanData(E(e, !1)), (e.textContent = ""));
        return this;
      },
      clone: function (e, t) {
        return (
        ...
        return u(
          ...
          function (e) {
            ...
            if (
              "string" == typeof e &&
              !De.test(e) &&
              !A[(Te.exec(e) || ["", ""])[1].toLowerCase()]
            ) {
              e = S.htmlPrefilter(e);
              try {
                for (; n < o; n++)
                  1 === (t = this[n] || {}).nodeType &&
                    (S.cleanData(E(t, !1)), (t.innerHTML = e));
                t = 0;
              } catch (e) {}
            }
      ...
      replaceWith: function () {
        ...
        return L(
          ...
          function (e) {
            ...
            S.inArray(this, n) < 0 &&
              (S.cleanData(E(this)), t && t.replaceChild(e, this));
          },
          n
        );
      },
    ...
    S.each(
      ...
      function (e, r) {
        S.fn[e] = function (e) {
          for (var t, n = [], o = S(e), i = o.length - 1, s = 0; s <= i; s++)
  ...
  function Ze() {
    ...
    i &&
      ...
      k.appendChild(Ue).appendChild(i),
  ...
  function ct(e, t, n, o, i, s) {
    ...
    for (; r < 4; r += 2)
      "margin" === n && (l += S.css(e, n + p[r], !0, i)),
        o
          ? ("content" === n && (l -= S.css(e, "padding" + p[r], !0, i)),
            "margin" !== n && (l -= S.css(e, "border" + p[r] + "Width", !0, i)))
          : ((l += S.css(e, "padding" + p[r], !0, i)),
            "padding" !== n
              ? (l += S.css(e, "border" + p[r] + "Width", !0, i))
              : (a += S.css(e, "border" + p[r] + "Width", !0, i)));
    return (
      !o &&
        0 <= s &&
        (l +=
  ...
  function dt(e, t, n) {
    ...
    return (
      ((!m.boxSizingReliable() && i) ||
        ...
        "auto" === r ||
        (!parseFloat(r) && "inline" === S.css(e, "display", !1, o))) &&
        e.getClientRects().length &&
        ((i = "border-box" === S.css(e, "boxSizing", !1, o)),
        (s = a in e) && (r = e[a])),
      (r = parseFloat(r) || 0) +
        ct(e, t, n || (i ? "border" : "content"), s, o, r) +
        "px"
    );
  }
  ...
  S.extend({
    ...
    style: function (e, t, n, o) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          c = e.style;
        if (
          (l || (t = ot(a)), (r = S.cssHooks[t] || S.cssHooks[a]), void 0 === n)
        )
      ...
      return (
        ...
        "normal" ===
          (i =
            void 0 ===
            (i =
              (s = S.cssHooks[t] || S.cssHooks[s]) && "get" in s
                ? s.get(e, !0, n)
                : i)
              ? Ke(e, t, o)
              : i) &&
      ...
      S.cssHooks[r] = {
        ...
        set: function (e, t, n) {
          var o = ze(e),
            ...
            s = (i || n) && "border-box" === S.css(e, "boxSizing", !1, o),
            n = n ? ct(e, r, n, s, o) : 0;
          return (
            s &&
              i &&
    ...
    S.each({ margin: "", padding: "", border: "Width" }, function (i, s) {
      (S.cssHooks[i + s] = {
        expand: function (e) {
          for (
            ...
            n[i + p[t] + s] = o[t] || o[t - 2] || o[0];
          return n;
        },
      }),
        "margin" !== i && (S.cssHooks[i + s].set = lt);
    }),
    S.fn.extend({
      css: function (e, t) {
        return u(
  ...
  function H(i, e, t) {
      ...
      f = function () {
        if (!s) {
          for (
            ...
            h.tweens[n].run(t);
          if ((p.notifyWith(i, [h, t, e]), t < 1 && o)) return e;
          o || p.notifyWith(i, [h, 1, 0]), p.resolveWith(i, [h]);
        }
        return !1;
      },
      h = p.promise({
    ...
    for (o in m)
      if (
        ...
        o !== r && ((m[r] = l), delete m[o]),
        (c = S.cssHooks[r]) && "expand" in c)
      )
        for (o in ((l = c.expand(l)), delete m[r], l))
          o in m || ((m[o] = l[o]), (v[o] = a));
      else v[r] = a;
    for (; d < u; d++)
      if ((n = H.prefilters[d].call(h, i, g, h.opts)))
        return (
          y(n.stop) &&
    ...
    return (
      ...
      S.fx.timer(S.extend(f, { elem: i, anim: h, queue: h.opts.queue })),
      h
    );
  }
  (S.Animation = S.extend(H, {
    tweeners: {
      "*": [
        function (e, t) {
    ...
    tweener: function (e, t) {
      for (
        var n, o = 0, i = (e = y(e) ? ((t = e), ["*"]) : e.match(C)).length;
        o < i;
        o++
      )
        (n = e[o]),
        ...
        if ((l = !S.isEmptyObject(t)) || !S.isEmptyObject(p))
          ...
          p))
            l ||
              ...
              h && P([e], !0),
              u.done(function () {
                for (o in (h || P([e]), x.remove(e, "fxshow"), p))
                  S.style(e, o, p[o]);
              })),
              (l = vt(h ? g[o] : 0, o, u)),
              o in g ||
    ...
    (S.speed = function (e, t, n) {
      ...
      return (
        ...
        (o.old = o.complete),
        (o.complete = function () {
          y(o.old) && o.old.call(this), o.queue && S.dequeue(this, o.queue);
        }),
        o
      );
    }),
      ...
      stop: function (i, e, s) {
        ...
        return (
          ...
          this.each(function () {
            ...
            else for (t in o) o[t] && o[t].stop && ft.test(t) && r(o[t]);
            for (t = n.length; t--; )
              n[t].elem !== this ||
                (null != i && n[t].queue !== i) ||
                (n[t].anim.stop(s), (e = !1), n.splice(t, 1));
            (!e && s) || S.dequeue(this, i);
          })
        );
      },
      finish: function (r) {
    ...
    ((r = T.createElement("input")).value = "t"),
    (r.type = "radio"),
  ...
  S.fn.extend({
    ...
    S.fn.extend({
      addClass: function (t) {
        ...
        if ((e = Tt(t)).length)
          for (; (n = this[a++]); )
            if (((r = O(n)), (o = 1 === n.nodeType && " " + M(r) + " "))) {
              for (s = 0; (i = e[s++]); )
                o.indexOf(" " + i + " ") < 0 && (o += i + " ");
              r !== (r = M(o)) && n.setAttribute("class", r);
            }
        return this;
      },
      ...
      toggleClass: function (i, t) {
        ...
        return "boolean" == typeof t && r
          ...
          ? this.each(function (e) {
              S(this).toggleClass(i.call(this, e, O(this), t), t);
            })
          : this.each(function () {
              var e, t, n, o;
              if (r)
                for (t = 0, n = S(this), o = Tt(i); (e = o[t++]); )
                  n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
              else
                (void 0 !== i && "boolean" != s) ||
                  ((e = O(this)) && x.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      hasClass: function (e) {
        for (var t, n = 0, o = " " + e + " "; (t = this[n++]); )
          if (1 === t.nodeType && -1 < (" " + M(O(t)) + " ").indexOf(o))
            return !0;
        return !1;
      },
    });
        ...
        val: function (t) {
          ...
          return arguments.length
            ? ((o = y(t)),
              this.each(function (e) {
                1 === this.nodeType &&
                  (null == (e = o ? t.call(this, e, S(this).val()) : t)
                    ? (e = "")
                    : "number" == typeof e
                    ? (e += "")
                    : Array.isArray(e) &&
      ...
      S.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (e, t) {
              for (
                var n, o, i = e.options, s = S.makeArray(t), r = i.length;
                r--;

              )
                ((o = i[r]).selected =
                  -1 < S.inArray(S.valHooks.option.get(o), s)) && (n = !0);
      ...
      (S.extend(S.event, {
        trigger: function (e, t, n, o) {
          ...
          if (
            ...
            ((e = e[S.expando]
              ? e
              : new S.Event(p, "object" == typeof e && e)).isTrigger = o
              ? 2
              : 3),
            (e.namespace = f.join(".")),
            ...
            if (!o && !c.noBubble && !g(n)) {
              for (
                r = c.delegateType || p, kt.test(r + p) || (h = h.parentNode);
                h;
                h = h.parentNode
              )
                u.push(h), (s = h);
              s === (n.ownerDocument || T) &&
                u.push(s.defaultView || s.parentWindow || w);
            }
        ...
        S.each({ focus: "focusin", blur: "focusout" }, function (n, o) {
          ...
          S.event.special[o] = {
            ...
            teardown: function () {
              ...
              t
                ? x.access(e, o, t)
                : (e.removeEventListener(n, i, !0), x.remove(e, o));
            },
          };
        }),
      w.location),
  ...
  (Wt.href = $t.href),
      ...
      ajax: function (e, t) {
          ...
          h.hasContent
            ...
            : ((e = h.url.slice(c.length)),
              h.data &&
                ...
                ((c += (At.test(c) ? "&" : "?") + h.data), delete h.data),
              !1 === h.cache &&
                ((c = c.replace(Ot, "$1")),
                (e = (At.test(c) ? "&" : "?") + "_=" + Pt.guid++ + e)),
              (h.url = c + e)),
          h.ifModified &&
            (S.lastModified[c] &&
        ...
        function a(e, t, n, o) {
          ...
          p ||
            ...
            (x.status = e),
            (x.statusText = (t || a) + ""),
            o ? v.resolveWith(g, [i, a, x]) : v.rejectWith(g, [x, a, s]),
            x.statusCode(b),
            (b = void 0),
            f && m.trigger(o ? "ajaxSuccess" : "ajaxError", [x, h, o ? i : s]),
            y.fireWith(g, [x, a]),
            f &&
    ...
    S.each(["get", "post"], function (e, i) {
      S[i] = function (e, t, n, o) {
        return (
          y(t) && ((o = o || n), (n = t), (t = void 0)),
          S.ajax(
            S.extend(
    ...
    Zt =
      (S.ajaxSetup({
        ...
        jsonpCallback: function () {
          var e = Vt.pop() || S.expando + "_" + Pt.guid++;
          return (this[e] = !0), e;
        },
      }),
      S.ajaxPrefilter("json jsonp", function (e, t, n) {
        ...
        if (r || "jsonp" === e.dataTypes[0])
          return (
            ...
            n.always(function () {
              void 0 === i ? S(w).removeProp(o) : (w[o] = i),
      ...
      (S.fn.load = function (e, t, n) {
        var o,
          ...
          a = e.indexOf(" ");
        return (
          -1 < a && ((o = M(e.slice(a))), (e = e.slice(0, a))),
          y(t)
            ? ((n = t), (t = void 0))
      ...
      (S.offset = {
        setOffset: function (e, t, n) {
          ...
          "static" === a && (e.style.position = "relative"),
            ...
            null != (t = y(t) ? t.call(e, n, S.extend({}, s)) : t).top &&
              (c.top = t.top - s.top + i),
            ...
            return u(
              ...
              function (e, t, n) {
                ...
                if (
                  ...
                  return o ? o[i] : e[t];
                o
                  ? o.scrollTo(s ? o.pageXOffset : n, s ? n : o.pageYOffset)
                  : (e[t] = n);
              },
              t,
              e,
  ...
  return (
    (S.noConflict = function (e) {
      return w.$ === S && (w.$ = Kt), e && w.jQuery === S && (w.jQuery = Gt), S;
    }),
    void 0 === I && (w.jQuery = w.$ = S),
    S
  );
}),
  (function (l, r, h, g) {
    "use strict";
    var i, s, a, d, t, c, p, u, o, e, n, f, m;
    function v(e, t) {
      var n,
        o,
        i,
      ...
      (e && e.isDefaultPrevented()) ||
        ...
        ((i = h.fancybox.getInstance()) && i.$trigger && i.$trigger.is(n)) ||
          ((s = t.selector
            ...
            : [n]),
          (r = h(s).index(n)),
          ((i = h.fancybox.open(s, t, (r = r < 0 ? 0 : r))).$trigger = n)));
    }
      ...
      h &&
        (h.fn.fancybox
          ...
          : ((e = {
              ...
              }).prototype,
              {
                ...
                addContent: function (e) {
                  ...
                  h.each(e, function (e, t) {
                    ...
                    h.isPlainObject(t)
                      ...
                      ? ((s = (n = h(t)).data() || {}),
                        ((s = h.extend(!0, {}, s, s.options)).$orig = n),
                      ...
                      (i.thumb =
                        i.opts.thumb || (i.$thumb ? i.$thumb[0].src : null)),
                      ...
                      i.opts.caption instanceof h ||
                        (i.opts.caption =
                          i.opts.caption === g ? "" : i.opts.caption + ""),
                      "ajax" === i.type &&
                        1 < (o = s.split(/\s+/, 2)).length &&
                        ...
                        t
                          ...
                          : ((r = h.fancybox.getTranslate(s.$slide)),
                            ...
                            u
                              ? ((c =
                                  r.left -
                                  (s.pos * r.width + s.pos * s.opts.gutter)),
                                h.each(d.slides, function (e, t) {
                                  t.$slide
                                  ...
                                  var n =
                                    t.pos * r.width + t.pos * t.opts.gutter;
                ...
                scaleToActual: function (e, t, n) {
                  ...
                  a.isAnimating ||
                    ...
                    (e = e === g ? 0.5 * d : e),
                    (t = t === g ? 0.5 * u : t),
                    ((o = h.fancybox.getTranslate(c)).top -=
                    ...
                    (s = 0.5 * u - 0.5 * f),
                    d < p &&
                      (i = 0 < (i = o.left * l - (e * l - e)) ? 0 : i) <
                        d - p &&
                      (i = d - p),
                    u < f &&
                      (s = 0 < (s = o.top * r - (t * r - t)) ? 0 : s) < u - f &&
                      (s = u - f),
                    a.updateCursor(p, f),
                    h.fancybox.animate(
                      c,
                      { top: s, left: i, scaleX: l, scaleY: r },
                      n || 366,
                      function () {
                        a.isAnimating = !1;
                      }
                        ...
                        return (
                          e
                            ...
                            .forEach(function (e, t) {
                              ...
                              n &&
                                ((o.value = n), (o.postfix = e[e.length - 1]));
                            }),
                          o
                        );
                      })).sort(function (e, t) {
                ...
                resolveImageSlideSize: function (e, t, n) {
                  ...
                  (e.width = t),
                    (e.height = n),
                    0 < o &&
                      ((e.width = o), (e.height = Math.floor((o * n) / t))),
                    0 < i &&
                      ((e.width = Math.floor((i * t) / n)), (e.height = i));
                },
                ...
                revealContent: function (e) {
                  ...
                  return (
                    ...
                    (o = parseInt(
                      e.forcedDuration === g ? o : e.forcedDuration,
                      10
                    )),
                    "zoom" === (t = !c && e.pos === s.currPos && o ? t : !1) &&
                      (e.pos === s.currPos &&
                      o &&
                      "image" === e.type &&
                      !e.hasError &&
                ...
                getThumbPos: function (e) {
                  ...
                  return (
                    !!(
                      ...
                      (i = r.elementFromPoint(i.x, i.y) === o),
                ...
                trigger: function (e, t) {
                  ...
                  if (
                    ...
                    o.unshift(i),
                    !1 ===
                      (n = h.isFunction(t.opts[e]) ? t.opts[e].apply(t, o) : n))
                  )
                    return n;
                  ("afterClose" !== e && i.$refs
                    ? i.$refs.container
                ...
                updateControls: function () {
                  ...
                  t.$slide.trigger("refresh"),
                    ...
                    o
                      ...
                      .prop(
                        "disabled",
                        !t.opts.loop && n >= e.group.length - 1
                      ),
                    "image" === t.type
                      ? o
            ...
            s.on("click.fb-start", "[data-fancybox]", v),
            ...
            (f = "fancybox-focus"),
            (m = null),
            s.on("mousedown mouseup focus blur", n, function (e) {
              switch (e.type) {
                case "mousedown":
                  m = h(this);
                  break;
    ...
    (n.prototype.destroy = function () {
      ...
      (n.prototype.limitMovement = function () {
        var e = this,
          ...
          u = Math.max(0, 0.5 * n - 0.5 * e),
          t = Math.min(t - a, 0.5 * t - 0.5 * a),
          a = Math.min(n - e, 0.5 * n - 0.5 * e);
        return (
          0 < o && d < l && (l = d - 1 + Math.pow(-d + s + o, 0.8) || 0),
          o < 0 && l < t && (l = t + 1 - Math.pow(t - s - o, 0.8) || 0),
          0 < i && u < c && (c = u - 1 + Math.pow(-u + r + i, 0.8) || 0),
          {
            top: (c =
      ...
      (n.prototype.onZoom = function () {
        var e = this,
          ...
          r = Math.floor(n * s),
          a = Math.floor(o * s),
          n = (n - r) * e.percentageOfImageAtPinchPointX,
          o = (o - a) * e.percentageOfImageAtPinchPointY,
          l = (e.newPoints[0].x + e.newPoints[1].x) / 2 - u(d).scrollLeft(),
          c = (e.newPoints[0].y + e.newPoints[1].y) / 2 - u(d).scrollTop(),
          l = l - e.centerPointStartX,
          t = {
            top: t + (o + (c - e.centerPointStartY)),
            left: i + (n + l),
            scaleX: s,
            scaleY: s,
          };
      ...
      (n.prototype.endZooming = function () {
        ...
        n.contentLastPos &&
          ...
          i < n.canvasWidth && s < n.canvasHeight
            ...
            : ((o = n.limitPosition(e, t, i, s)),
              u.fancybox.animate(n.$content, o, 150)));
      }),
      (n.prototype.onTap = function (t) {
        function e(e) {
          if (((e = r.opts[e]), (e = u.isFunction(e) ? e.apply(s, [r, t]) : e)))
            switch (e) {
              case "close":
    ...
    (o = 0),
      ...
      (r.prototype.lazyLoad = function () {
        ...
        if (
          ...
          for (
            var i = t - 1, r = n, a = s.$slider.find(".slick-slide"), l = 0;
            l < s.options.slidesToScroll;
            l++
          )
            i < 0 && (i = s.slideCount - 1),
              (e = (e = e.add(a.eq(i))).add(a.eq(r))),
              i--,
              r++;
        o(e),
          ...
          !0 === i.options.centerMode
            ...
            : ((n = i.slideCount % i.options.slidesToShow),
              ...
              i.slideCount - e < i.options.slidesToShow
                ? s.slice(t - (i.options.slidesToShow - n), t + n)
        ...
        return (
          ...
          !o.options.verticalSwiping && !o.swiping && 4 < i
            ...
            : (!0 === o.options.verticalSwiping &&
              ...
              !1 === o.options.vertical
                ? (o.swipeLeft = t + n * e)
                : (o.swipeLeft = t + n * (o.$list.height() / o.listWidth) * e),
  ...
  $(function () {
    var e = $(".header__burger"),
      t = $(document);
    function n() {
      150 < t.scrollTop() ? e.addClass("scrolled") : e.removeClass("scrolled");
    }
    $(window).on("scroll", n),
      n(),
      $(".header__link, .logo, .footer__link").on("click", function (e) {
        e.preventDefault();
      ...
      $(".accesories__slider").slick({
        ...
        responsive: [
          {
            breakpoint: 1300,
            settings: { centerPadding: "40px", slidesToShow: 6 },
          },
          {
            breakpoint: 1100,
            settings: { centerPadding: "40px", slidesToShow: 4 },
          },
          {
            breakpoint: 800,
